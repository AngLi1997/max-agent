...
const formState = reactive({ name: '', provider: undefined as string | undefined, status: 'active' as 'active' | 'inactive' })
...
async function handleSubmit() {
  ...
  try {
    const data = { name: formState.name, provider: formState.provider!, status: formState.status }
    if (editingId.value !== null) {
      await updateModelApi(editingId.value, data)
